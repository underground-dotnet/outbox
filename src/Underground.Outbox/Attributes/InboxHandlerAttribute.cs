...
/// <summary>
/// Binds an <see cref="IInboxMessageHandler{T}"/> to the inbox of one <see cref="DbContext"/>:
/// <c>[InboxHandler&lt;OrdersContext&gt;]</c>. Required - a Handler without it is reported as
...
/// </remarks>
/// <typeparam name="TContext">The context whose inbox this Handler serves.</typeparam>
[AttributeUsage(AttributeTargets.Class, AllowMultiple = false, Inherited = false)]
// S2326: the type parameter is the whole payload - the source generator reads it to group handlers
#pragma warning disable S2326 // Unused type parameters should be removed
public sealed class InboxHandlerAttribute<TContext> : Attribute where TContext : DbContext;
