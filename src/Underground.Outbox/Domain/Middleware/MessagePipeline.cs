...
/// <see cref="DispatchMessage{TEntity}"/> sits innermost. The inbox and the outbox differ by one middleware,
...
/// </remarks>
internal sealed class MessagePipeline<TEntity>(
    IReadOnlyList<IMessageMiddleware<TEntity>> middleware,
