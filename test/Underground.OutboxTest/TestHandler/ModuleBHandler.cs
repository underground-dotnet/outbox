...
/// <summary>Handles <see cref="SharedContract"/> for module B.</summary>
[OutboxHandler<ModuleBDbContext>]
public class ModuleBHandler : IOutboxMessageHandler<SharedContract>
{
